...
echo "Optional (for HTTPS + HTTP->HTTPS redirect at first boot):"
echo "  racewrangler-cert.pem"
echo "  racewrangler-key.pem"
echo "  (or use: bash scripts/setup-sd-card.sh --type pi5 --mount /mnt/j --cert <cert.pem> --key <key.pem>)"
echo ""
